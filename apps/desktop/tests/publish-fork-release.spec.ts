...
describe('fail-closed fork publication', () => {
  ...
  it('publishes the exact alpha2 sequence-21 source plan through one owned and fully verified draft', async () => {
    expect(reviewedPlan).toMatchObject({ version, upstreamVersion: '0.1.6-alpha.2', sequence: 21, channel: 'cloga-windows-x64' })
