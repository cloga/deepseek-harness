 ...
 * @param options Explicit mode; only a validated unsigned Windows x64 fork uses capability-owned settings.
 * @returns Isolated environment with file-owned official settings or explicit fork capability inputs.
 */
export function loadDesktopPackageEnvironment(
  platform: 'win32' | 'darwin',
  environment?: NodeJS.ProcessEnv,
  appRoot?: string,
  options?: { unsigned?: boolean, arch?: string },
): NodeJS.ProcessEnv
