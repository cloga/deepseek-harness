 ...
 * @param officeEngine - Exact kit-declared engine suffix for this target.
...
export function desktopRuntimeFileExclusion(
  ...
  if (name.startsWith('@deepseek-ai/libreoffice-kit-') && name !== `@deepseek-ai/libreoffice-kit-${officeEngine}`) {
    return 'LibreOffice other platform'
  }
