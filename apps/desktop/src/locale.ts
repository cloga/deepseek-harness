...
export const en = {
  ...
  pluginCommandTitle: 'Apply Plugin Change',
  pluginCommandPrompt: 'Restart the Desktop Host to apply this change?',
  pluginCommandApply: 'Apply and Restart Host',
...
export const zh = {
  ...
  pluginCommandTitle: '应用插件更改',
  pluginCommandPrompt: '是否重启 Desktop Host 以应用此更改？',
  pluginCommandApply: '应用并重启 Host',
