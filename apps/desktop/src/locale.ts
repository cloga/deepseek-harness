...
export const en = {
  ...
  sourceReleaseUpdate: 'Update this plugin through its verified release source, not the npm version action.',
  install: 'Install',
  cancel: 'Cancel',
  installed: 'Installed',
...
export const zh = {
  ...
  sourceReleaseUpdate: '请通过此插件的已验证 Release 来源更新，不要使用 npm 版本更新。',
  install: '安装',
  cancel: '取消',
  installed: '已安装',
  noPlugins: '还没有安装桌面插件。',
