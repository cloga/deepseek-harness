...
flowchart LR
  ...
  plugin_dsh_base_model_routing["model-routing<br/>@deepseek-ai/dsh-model-routing"]
  cfg --> plugin_dsh_base_model_routing
...
| `model-routing` | `@deepseek-ai/dsh-model-routing` |
