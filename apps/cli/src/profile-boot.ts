...
/** Root filename retained on the CLI API; canonical bytes and writes belong to shared app boot. */
export { PROFILE_ROOT_FILENAME } from '@deepseek-ai/dsh-app-boot'
...
export interface RunProfileOptions {
  ...
  /** Require launcher-owned staging instead of mutating installed packages in the running profile. */
  stagedPackageTransactions?: boolean
  /** Awaited after base Host services, before any profile entry mounts; resources belong to the supplied Fiber. */
