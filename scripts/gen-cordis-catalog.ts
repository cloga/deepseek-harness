...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ModelSelectionQuery: 'core.md',
  ModelSelectionResolution: 'core.md',
  ...
  ModelRoutingMode: 'llm-streaming.md',
  DelegationRoutingCapture: 'llm-streaming.md',
  ResolveDelegationRoutingRequest: 'llm-streaming.md',
  ResolvedDelegationRouting: 'llm-streaming.md',
  Inbox: 'core.md',
  InboxItem: 'core.md',
  ...
  SessionSelectAutoModelRequest: 'session.md',
  SessionSelectAutoModelValue: 'session.md',
...
export const CORDIS_CATALOG_POLICY: CordisCatalogPolicy = {
  ...
  inheritedEvents: [
    ...
    { name: 'hmr/change', summary: 'A watched source file changed on disk.', source: 'packages/boot/hmr/src/index.ts:30' },
    { name: 'hmr/reload', summary: 'Plugins are being reloaded after a change.', source: 'packages/boot/hmr/src/index.ts:35' },
  ...
  inheritedServices: [
    ...
    { name: 'ctx.hmr', summary: 'The serialized module and profile-configuration reload owner (present under the hmr plugin).', source: 'packages/boot/hmr/src/index.ts:22' },
  ],
}
