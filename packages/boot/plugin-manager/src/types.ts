...
export interface ChangeResult {
  ...
  /** A durable staged graph; the active profile remains unchanged until separate shell activation. */
...
/** Identifies an installation and its log/cancellation events; staged profiles require a lowercase UUID retained for pending recovery. */
