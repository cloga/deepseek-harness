...
describe('/compact human command', () => {
  ...
  it.each([
    ...
    ['summary-truncated', 'The compaction summary reached its output token cap. No incomplete checkpoint was committed. Try a different selected model or adjust the configured summary budget.'],
