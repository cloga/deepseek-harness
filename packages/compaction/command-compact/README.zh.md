...
| 摘要输出达到 token 上限 | `The compaction summary reached its output token cap. No incomplete checkpoint was committed. Try a different selected model or adjust the configured summary budget.` |
