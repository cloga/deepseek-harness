...
declare module '@deepseek-ai/cordis' {
  interface Events {
    /**
     * Admit or wrap an already authenticated shared API request, including its complete body transfer.
     * Existing requests finish when a listener refuses subsequent requests.
     ...
     * @mode waterfall
     */
    'connection/request'(request: IncomingMessage, response: HttpServerResponse, next: () => Promise<void>): Promise<void>
  }
}
