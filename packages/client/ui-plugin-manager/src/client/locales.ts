...
export const zh = {
  ...
  preparedNotice: '事务 {id} 仅在私有候选暂存；现有插件未改变。仍需 Desktop 独立确认、安全检查及激活。',
...
export const en = {
  ...
  preparedTitle: 'Prepared privately, not activated',
  ...
  preparedNotice: 'Transaction {id} is only staged privately; active plugins are unchanged. Separate Desktop confirmation, safety checks and activation are still required.',
