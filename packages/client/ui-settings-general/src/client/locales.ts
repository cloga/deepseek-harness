...
export const zh = {
  ...
  'desktop.baseline.preserved': '已保留插件选择',
  'desktop.baseline.pending': '发布基线待验证',
  'desktop.baseline.detail': '{name} 的发布基线尚未通过验证。你的插件选择保持不变；这不表示更新已验证完成。打开说明了解处理方式。',
  ...
  'desktop.update.managedReady': '确认安装程序',
  'desktop.update.managedChannel': 'cloga 已验证 GitHub Release（交互式安装）',
  ...
  'desktop.update.unsavedInput': '存在未发送或尚未确认的输入，已阻止重启。请保存或发送所有会话的草稿，处理完附件及提交操作后重试。',
  'title': '设置',
  'close': '关闭',
  'openDocument': '打开配置文件',
...
export const en = {
  ...
  'desktop.baseline.preserved': 'Plugin choices preserved',
  'desktop.baseline.pending': 'Baseline verification pending',
  'desktop.baseline.detail': 'The release baseline for {name} is not qualified. Your plugin choices are unchanged; this does not certify update completion. Open for recovery guidance.',
  ...
  'desktop.update.managedReady': 'Review installer',
  'desktop.update.managedChannel': 'cloga verified GitHub Release (interactive installer)',
  ...
  'desktop.update.unsavedInput': 'Restart is blocked by unsent or unconfirmed input. Save or send drafts and finish attachments and submissions in every Conversation before retrying.',
  'title': 'Settings',
  'close': 'Close',
