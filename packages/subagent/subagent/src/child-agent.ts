...
/**
 * Merge child overrides over a captured parent route without reading a live Agent.
 * @param parentOptions - Parent delegation options captured by the caller.
 * @param requested - Per-child overrides, if any.
 * @returns Child options without delegation-depth stamping.
 */
