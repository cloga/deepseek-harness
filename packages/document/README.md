...
- [Independent LibreOffice kit](https://www.npmjs.com/package/@deepseek-ai/libreoffice-kit/v/0.0.1) — engine distribution and application integration; Desktop must verify its declared target engine bytes.
