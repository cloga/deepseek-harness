...
The current release plan retains Core `0.1.6-alpha.1` and pins immutable [Copilot `0.4.0-alpha.33`](https://github.com/cloga/dsh-github-copilot/releases/tag/v0.4.0-alpha.33). Copilot alpha.33 supports both Core alpha.1 and alpha.2, but that compatibility does not qualify the separately owned Core alpha.2 Desktop adaptation.
...
Copilot alpha.33 post-merge [run 35559690050](https://github.com/cloga/dsh-github-copilot/actions/runs/35559690050) passed compatibility, exact alpha.1/alpha.2 Windows/Ubuntu, verification, packaging, and GitHub publication; immediate npm visibility verification failed. Independent read-only verifier [run 35560198211, attempt 2](https://github.com/cloga/dsh-github-copilot/actions/runs/35560198211/attempts/2) passed npm/GitHub same-byte and alpha-tag verification. The Desktop consumes the already published immutable GitHub bytes; it neither republishes nor rewrites the plugin release.
