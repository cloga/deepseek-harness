...
The current release plan retains Core `0.1.6-alpha.1` and pins immutable [Copilot `0.4.0-alpha.32`](https://github.com/cloga/dsh-github-copilot/releases/tag/v0.4.0-alpha.32). Copilot alpha.32 supports both Core alpha.1 and alpha.2, but that compatibility does not qualify the separately owned Core alpha.2 Desktop adaptation.
