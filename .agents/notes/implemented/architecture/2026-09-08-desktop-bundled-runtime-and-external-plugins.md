...
Desktop validates package mutations and a staged Host before it swaps the active profile. The [verified release transaction decision](2026-09-15-desktop-verified-release-plugin-transactions.md) owns activation rollback, receipt attestation, and package-manager isolation. Recorded host links identify owned directories independently of package-operation completion.
