...
Desktop 在停止活动 Host 前，先在私有 staging profile 中准备并 health-check 插件修改。激活失败会恢复先前 profile；来源验证与事务归属遵循[验证 Release 事务决策](2026-09-15-desktop-verified-release-plugin-transactions.zh.md)。
