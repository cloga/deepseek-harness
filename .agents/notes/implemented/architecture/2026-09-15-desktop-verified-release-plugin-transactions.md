...
The recovery release plan selects immutable `dsh-github-copilot@0.4.0-alpha.21`, whose packed authorization and Schemastery dependencies are required Host peers. Published artifact and historical shared-inventory checks do not establish new Desktop materialization or installed UI behavior. Models, account, discovery, device-code, and update persistence remain recovery rehearsal and release acceptance obligations.
